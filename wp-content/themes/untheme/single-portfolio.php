...
<main id="primary" class="site-main">
	...
	<section class="page-section _single-post-portfolio">
		<div class="fixed-container">
			<div class="single-post-portfolio__header">
			...
			<div class="single-post-portfolio__content">
				...
				?>
					...
					<div class="swiper portfolio-slider">
						...
						<div class="swiper-wrapper portfolio-slider__wrapper">
							...
							?>
								<div class="swiper-slide portfolio-slider__slide">
									<a data-fancybox="gallery" <?php if ($prf_desc = $portfolio_pic['crb_portfolio_image_desc']) : echo 'data-caption="' . $prf_desc . '"';
																endif; ?> href="<?php echo $portfolio_pic_url ?>">
						...
						<div class="portfolio-slider__button-prev">
						...
						<div class="portfolio-slider__button-next">
							<svg width="47" height="30" viewBox="0 0 47 30" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<?php
				if ($portfolio_description = carbon_get_post_meta(get_the_ID(), 'crb_portfolio_desc')) {
				?>
					<div class="portfolio-description"><?php echo $portfolio_description ?></div>
				<?php
				}
				?>
