...
<main id="primary" class="site-main">
	...
	<section class="page-section _single-post-decor">
		<div class="fixed-container">
			<div class="single-post-decor__header">
				
					<ul class="breadcrumbs__list">
						<a href="<?php echo site_url() ?>">Главная</a>
						<span>/</span>
						<a href="<?php echo site_url('decor') ?>">Декор</a>
						<span>/</span>
						<?php the_title() ?>
					</ul>
					...
					?>
				<?php if ($decor_pics = carbon_get_post_meta(get_the_ID(), 'crb_decor_pics')) {
					?>

						<!-- Slider main container -->
						<div class="swiper decor-slider">
							<!-- Additional required wrapper -->
							<div class="swiper-wrapper decor-slider__wrapper">
								<!-- Slides -->
								 
								<?php
								foreach ($decor_pics as $decor_pic) {
									$decor_pic_url = wp_get_attachment_image_url($decor_pic['crb_decor_image'], 'full');
								?>
									<div class="swiper-slide decor-slider__slide">
										<a data-fancybox="gallery" <?php if ($decor_desc = $decor_pic['crb_decor_image_desc']) : echo 'data-caption="'.$decor_desc.'"'; endif;?>  href="<?php echo $decor_pic_url ?>">
											<img src="<?php echo $decor_pic_url ?>" alt="<?php $decor_pic['crb_decor_image_alt'] ?>">
										</a>
										<?php if ($decor_desc) {
										?>
											<div class="decor-slider__slide__desc">
												<?php echo $decor_desc ?>
											</div>
										<?php
										}
							 ...
							 <div class="decor-slider__button-prev">
							...
							<div class="decor-slider__button-next">
								<svg width="47" height="30" viewBox="0 0 47 30" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="single-post-decor__content">
				<?php the_content() ?>
			</div>
